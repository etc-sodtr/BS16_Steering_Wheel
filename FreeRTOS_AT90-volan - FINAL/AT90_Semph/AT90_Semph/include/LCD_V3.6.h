...
#define LCD_DATA_PORT A //Change to port where LCD_DATA_BUS_PINs are connected: [A,B,C,D,E,F...];
...
#define LCD_D4 3 //Data4_Bit from LCD_DPORT;
#define LCD_D5 2 //Data5_Bit from LCD_DPORT;
#define LCD_D6 1 //Data6_Bit from LCD_DPORT;
#define LCD_D7 0 //Data7_Bit from LCD_DPORT;
#define LCD_INST_PORT A
#define LCD_EN 4 //Enable_Data from LCD_IPORT;
#define LCD_RS 6 //Register_Selector_Bit from LCD_IPORT;
#define LCD_RW 5 //Read_Write_Bit from LCD_IPORT;
